...
namespace DAO
{
    ...
    public class MD_Tabela : MDN_Model
    {
        ...
        public MD_Projeto Projeto
        {
            ...
            {
                if (this.proj == null)
                    this.proj = new MD_Projeto(this.projeto);
        ...
        public override void Load()
        {
            ...
            string sentenca = base.table.CreateCommandSQLTable() + " WHERE CODIGO = " + Codigo + " AND PROJETO = " + this.Projeto.Codigo;
        ...
        public override bool Delete()
        {
            ...
            string sentenca = "DELETE FROM " + this.table.Table_Name + " WHERE CODIGO = " + this.Codigo + " AND PROJETO = " + this.Projeto.Codigo;
        ...
        public override bool Update()
        {
            ...
            sentenca = "UPDATE " + table.Table_Name + " SET " +
                        ...
                        " NOTAS = '" + this.Notas + "' " +
                        "WHERE CODIGO = " + this.Codigo +" AND PROJETO  = " + this.Projeto.Codigo;
        ...
        public override bool Insert()
        {
            ...
            sentenca = "INSERT INTO " + table.Table_Name + " (CODIGO, PROJETO, NOME, DESCRICAO, NOTAS) " +
                       " VALUES (" + this.Codigo + ", " + this.Projeto.Codigo + ", '" + this.Nome + "', '" + this.Descricao + "', '" + this.Notas + "')";
