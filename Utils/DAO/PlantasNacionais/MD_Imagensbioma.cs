...
namespace DAO
{
    ...
    /// <summary>
    /// [IMAGENSBIOMA] Tabela IMAGENSBIOMA
    /// </summary>
    public class MD_Imagensbioma : MDN_Model
    {
        #region Atributos e Propriedades

        private int id;
        /// <summary>
        /// [ID] ID da imagem do bioma
        /// <summary>
        public int Id
        {
            get
        ...
        private int idbioma;
        /// <summary>
        /// [IDBIOMA] ID do bioma ao qual a imagem faz parte
        /// <summary>
        public int Idbioma
        {
            get
        ...
        /// <summary>
        /// [CAMINHO] Caminho url onde está salvo a imagem
        /// <summary>
        ...
        /// <summary>
        /// [IDUSUARIO] ID do usuário que cadastrou a imagem.
        /// <summary>
        ...
        /// </summary>
        public MD_Imagensbioma()
            : base()
        {
            base.table = new MDN_Table("IMAGENSBIOMA");
        ...
        /// </summary>
        /// <param name="ID">ID da imagem do bioma
        public MD_Imagensbioma(int id)
            :this()
        {
            this.id = id;
            this.Load();
        ...
        {
            Util.CL_Files.WriteOnTheLog("MD_Imagensbioma.Load()", Util.Global.TipoLog.DETALHADO);
        ...
        public override bool Insert()
        {
            ...
            sentenca = "INSERT INTO " + table.Table_Name + " (" + table.TodosCampos() + ")" + 
                              " VALUES (" + this.id + ", " + this.idbioma + ",  '" + this.caminho + "', " + this.idusuario + ")";
        ...
        public override bool Update()
        {
            ...
            sentenca = "UPDATE " + table.Table_Name + " SET " + 
                        "ID = " + Id + ", IDBIOMA = " + Idbioma + ", CAMINHO = '" + Caminho + "', IDUSUARIO = " + Idusuario + "" + 
                        " WHERE ID = " + Id + "";
