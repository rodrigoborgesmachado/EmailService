...
namespace DAO
{
    ...
    public class MD_Relacao : MDN_Model
    {
        ...
        int codigoProjeto = 0;
        MD_Projeto projeto = null;
        /// <summary>
        /// [CODIGOPROJETO] Código do projeto
        /// </summary>
        public MD_Projeto Projeto
        {
            get
            {
                if (this.projeto == null)
                    this.projeto = new MD_Projeto(codigoProjeto);
                return this.projeto;
            }
        }
        ...
        public MD_Tabela TabelaOrigem
        {
            get
            {
                if (this.tabelaOrigem == null)
                    this.tabelaOrigem = new MD_Tabela(this.codigoTabelaOrigem, this.Projeto.Codigo);
        ...
        public MD_Tabela TabelaDestino
        {
            get
            {
                if (this.tabelaDestino == null)
                    this.tabelaDestino = new MD_Tabela(this.codigoTabelaDestino, this.Projeto.Codigo);
        ...
        public MD_Relacao(int codigo, MD_Projeto projeto, MD_Tabela tabelaOrigem, MD_Tabela tabelaDestino, MD_Campos campoOrigem, MD_Campos campoDestino) : 
            this()
        {
            Util.CL_Files.WriteOnTheLog("MD_Relacao()", Util.Global.TipoLog.DETALHADO);
            ...
            this.codigoProjeto = this.Projeto.Codigo;
        ...
        public override bool Insert()
        {
            ...
            sentenca = "INSERT INTO " + table.Table_Name + " (CODIGO, CODIGOPROJETO, TABELAORIGEM, CAMPOORIGEM, TABELADESTINO, CAMPODESTINO, CARDINALIDADEORIGEM, CARDINALIDADEDESTINO, FOREINGKEY) " +
                              " VALUES (" + this.Codigo + ", " + this.Projeto.Codigo + ", " + this.TabelaOrigem.Codigo + ", " + this.CampoOrigem.Codigo + ", " + this.TabelaDestino.Codigo + ", " + this.CampoDestino.Codigo + ", '" + this.CardinalidadeOrigem + "', '" + this.CardinalidadeDestino + "', '" + this.NomeForeingKey + "')";
            if (DataBase.Connection.Insert(sentenca))
            {
                Empty = false;
                Util.Funcoes.CriarArquivoAtualizarDER();
        ...
        public override bool Update()
        {
            ...
            sentenca = "UPDATE " + table.Table_Name + " SET " +
                                " CODIGOPROJETO = " + this.Projeto.Codigo + "," +
            ...
            bool retorno = DataBase.Connection.Update(sentenca);
